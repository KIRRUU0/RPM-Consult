    ...
    <section className="relative min-h-[90vh] md:min-h-[920px] flex items-center overflow-hidden bg-on-background">
      ...
      <div className="absolute inset-0 z-0">
        <motion.img
          ...
          src="https://lh3.googleusercontent.com/aida-public/AB6AXuC0HOISwjyTZd1P04JQYd9QVk2loYnDxxFt8Tdq6kwD7whbGYA5WVAWVt7udp9SasLkYFjQ6_gThJjk6H0vfJ5-rLrQurr035yEhY2De5zy6HF7saYjPjfw6KcUxVSlNKzqSPmZV-oeNHjZ3EPQy-Xli0-FVTWfdKWktqWzrZlsTVyBmMF29LHB8n_4cKLOv0CcA0eXgio2lx2B9RrdEx1MBOizYveSRkPbhRNeTR6RLYW2b-Wx9xXKPERTlGzEy1CUemm_LoZ7qrw"
          onError={(e) => { e.target.src = 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1600&auto=format&fit=crop'; }}
        />
        {/* Overlays */}
      ...
      {/* Decorative overlapping background elements (Parallax shape in CSS) */}
      <div 
        style={{ 
      ...
      <div className="relative z-20 max-w-container-max mx-auto px-4 md:px-margin-desktop w-full text-center lg:text-left py-20 lg:py-0">
        ...
        >
          ...
          >
            Solusi Pajak &amp; <br />
            <span className="text-primary-fixed block lg:inline-block mt-2 lg:mt-0">Bisnis Terpercaya</span>
          </motion.h1>
          ...
          >
            Empowering organizations through precise financial leadership and strategic legal oversight.
            We deliver confidence through real experience and technology.
          </motion.p>
