export const translations = {
  id: {
    ...
    hero: {
      badge: 'Solusi Hukum, Pajak & Bisnis Profesional',
      title1: 'Solusi Pajak &',
      title2: 'Bisnis Terpercaya',
      subtitle: 'Memberdayakan organisasi melalui kepemimpinan keuangan yang tepat dan pengawasan hukum yang strategis. Kami memberikan keyakinan melalui pengalaman nyata dan teknologi.',
      btnSolutions: 'Solusi Kami',
      btnContact: 'Hubungi Ahli',
    ...
    leadership: {
      badge: 'Profesional Kami',
      title: 'Our Key Person',
      desc: 'Didukung oleh para ahli tepercaya yang memiliki integritas tinggi serta pengalaman panjang di bidang hukum, perpajakan, akuntansi, dan konsultasi bisnis.',
      seeBio: 'Lihat Biodata',
      modalEducation: 'Pendidikan',
      modalCredentials: 'Sertifikasi & Kredensial',
      modalContact: 'Hubungi langsung',
      tabs: {
        all: 'Semua',
        directors: 'Direksi',
        advisors: 'Penasihat & Manajer',
        seniors: 'Konsultan Senior',
        juniors: 'Konsultan Junior',
        support: 'Dukungan Operasional'
      }
    },
    values: {
    ...
    contact: {
      badge: 'Hubungi Kami',
      title: 'Kirim Pesan',
      desc: 'Pintu kami selalu terbuka untuk percakapan strategis. Hubungi tim ahli kami hari ini untuk konsultasi.',
      directCall: 'Komunikasi Langsung',
      ...
      formPlaceholders: {
        ...
        message: 'Jelaskan detail pertanyaan atau kebutuhan konsultasi Anda...'
      },
      formErrors: {
      ...
      formSubmitting: 'Memproses Pertanyaan...',
      formSubmit: 'Kirim Pesan',
      formSuccessTitle: 'Terima Kasih!',
      formSuccessDesc: 'Pesan Anda telah berhasil dikirim. Konsultan dari RPM Consult akan menghubungi Anda kembali dalam waktu 24 jam.'
    },
    footer: {
      desc: 'PT Raka Pradipta Mahawira (RPM Consult) menyediakan layanan profesional terintegrasi untuk Solusi Hukum, Pajak & Bisnis.',
      officesTitle: 'Kantor Kami',
      office1: 'Kantor PIK 2 (Pusat)',
      office2: 'Kantor Alam Sutera',
      portalsTitle: 'Portal & Domain Staff',
      newsletterTitle: 'Newsletter',
      newsletterDesc: 'Berlangganan untuk menerima pembaruan peraturan perpajakan dan ringkasan berita konsultasi.',
      newsletterPlaceholder: 'Alamat Email',
      newsletterSuccess: 'Berhasil berlangganan! Terima kasih.',
  ...
  en: {
    ...
    hero: {
      badge: 'Professional Legal, Tax & Business Solutions',
      title1: 'Trusted Tax &',
      title2: 'Business Solutions',
      subtitle: 'Empowering organizations through precise financial leadership and strategic legal oversight. We deliver confidence through real experience and technology.',
    ...
    leadership: {
      ...
      title: 'Our Key Person',
      desc: 'Supported by trusted experts with high integrity and extensive experience in law, taxation, accounting, and business consulting.',
      seeBio: 'View Bio',
      modalEducation: 'Education',
      modalCredentials: 'Certifications & Credentials',
      modalContact: 'Direct Contact',
      tabs: {
        all: 'All',
        directors: 'Directors',
        advisors: 'Advisors & Managers',
        seniors: 'Senior Consultants',
        juniors: 'Junior Consultants',
    ...
    contact: {
      ...
      formPlaceholders: {
        ...
        message: 'Describe your legal, tax, or business inquiry details...'
      },
      formErrors: {
      ...
      formSubmitting: 'Processing Inquiry...',
      formSubmit: 'Send Inquiry',
      formSuccessTitle: 'Thank You!',
      formSuccessDesc: 'Your inquiry has been successfully sent. A consultant from RPM Consult will follow up with you within 24 hours.'
    },
    footer: {
      desc: 'PT Raka Pradipta Mahawira (RPM Consult) provides professional integrated Legal, Tax & Business Solutions.',
      officesTitle: 'Our Offices',
      office1: 'PIK 2 Office (Headquarters)',
      office2: 'Alam Sutera Office',
      portalsTitle: 'Staff Portals & Domains',
      newsletterTitle: 'Newsletter',
      newsletterDesc: 'Subscribe to receive tax regulation updates and consulting news digests.',
